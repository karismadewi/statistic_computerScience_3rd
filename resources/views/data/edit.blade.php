            ...
            <div class="table-responsive">
                ...
                @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" value="{{$data->tugas1}}" name="tugas1" id="tugas1">
                    </div>
                    <div class="mb-3">
                        <label for="uts" class="form-label">Midterm Exam</label>
                        <input type="number" class="form-control" value="{{$data->uts}}" name="uts" id="uts">
                    </div>
                    <div class="mb-3">
                        <label for="tugas2" class="form-label">Task 2</label>
                        <input type="number" class="form-control" value="{{$data->tugas2}}" name="tugas2" id="tugas2">
                    </div>
                    <div class="mb-3">
                        <label for="kuis" class="form-label">Quiz</label>
                        <input type="number" class="form-control" value="{{$data->kuis}}" name="kuis" id="kuis">
                    </div>
                    <div class="mb-3">
                        <label for="uas" class="form-label">Final Exam</label>
                        <input type="number" class="form-control" value="{{$data->uas}}" name="uas" id="uas">
                    </div>
